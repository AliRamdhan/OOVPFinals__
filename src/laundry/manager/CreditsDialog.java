...
public class CreditsDialog extends JDialog {
    public CreditsDialog() {
        ...
        JLabel nameLabel = new JLabel("Name: Farhan Ali Ramadhan");
        nameLabel.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        bodyPanel.add(nameLabel);

        JLabel emailLabel = new JLabel("Email: farhan.ramadhan@student.president.ac.id");
        emailLabel.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        bodyPanel.add(emailLabel);

        JLabel idLabel = new JLabel("Student ID: 001202200044");
